...
class Create extends AbstractCommand
{
    ...
    protected function configure()
    {
        ...
        $this->addOption('code', null, InputOption::VALUE_REQUIRED, 'Write the code in the migration');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $classes = [
            ...
            '$namespace' => $namespace,
            '$useClassName' => $this->getMigrationBaseClassName(),
            '$className' => $className,
    ...
    protected function getMigrationBaseClassName()
    {
        return $this->getConfig()->getMigrationBaseClassName(false);
    }
}
